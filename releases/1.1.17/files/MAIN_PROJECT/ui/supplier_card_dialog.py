...
class SupplierCardDialog(QDialog):
    def __init__(self, supplier_id, supplier_name, parent=None):
        ...
        if self._supplier:
            ...
            form.addRow("Р/с:", QLabel(_str(self._supplier.get("bank_account"))))
            form.addRow("К/с:", QLabel(_str(self._supplier.get("corr_account"))))
            form.addRow("Банк:", QLabel(_str(self._supplier.get("bank_name"))))
            form.addRow("БИК:", QLabel(_str(self._supplier.get("bik"))))
