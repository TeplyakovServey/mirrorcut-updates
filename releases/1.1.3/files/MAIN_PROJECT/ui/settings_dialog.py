...
class SettingsDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.edit_cutting_dir.setPlaceholderText("не задана — папка программы")
        ...
        form.addRow("Папка раскроя (PDF):", row_cutting)
    ...
    def _load_values(self):
        ...
        cutting = get_cfg_string(cfg, 'paths', 'cutting_pdf_dir', '') if cfg else ''
    ...
    def _save_and_accept(self):
        ...
        cfg.set('paths', 'cutting_pdf_dir', self.edit_cutting_dir.text().strip())
