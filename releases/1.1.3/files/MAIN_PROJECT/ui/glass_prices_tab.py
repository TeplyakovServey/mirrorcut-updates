...
GLASS_PRICE_SECTIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        "key": "delivery_price",
        "sql": "delivery_price",
        "title": "Доставка и замер",
        "order": "name",
        "pk": ["id"],
        "hint": "Тарифы: внутри КАД, база за КАД, руб/км, замер и т.д. (имена строк использует формула доставки).",
    },
    {
        "key": "facet_price",
        "sql": "facet_price",
...
class GlassPricesTab(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._sections = {s["key"]: s for s in GLASS_PRICE_SECTIONS}
    ...
    def _section_meta(self) -> Dict[str, Any]:
        ...
        return self._sections.get(key) or GLASS_PRICE_SECTIONS[0]
