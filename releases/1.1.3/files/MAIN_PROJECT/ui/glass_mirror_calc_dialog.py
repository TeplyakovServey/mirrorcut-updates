...
class GlassMirrorCalcDialog(QDialog):
    def __init__(
        ...
        *,
        ...
        self._btn_add_product.setVisible(bool(self._allow_add_product))
        ...
        if self._order_id is None:
            ...
            self._btn_add_product.setToolTip("")
        top.addWidget(self._btn_add_product)
        lay.addLayout(top)
        ...
        if self._quick_client_preset and not self._quick_estimate_mode:
            try:
