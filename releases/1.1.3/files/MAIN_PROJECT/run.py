...
if getattr(sys, "frozen", False):
    ...
    try:
        from delta_import_overlay import install_delta_import_overlay
    ...
    try:
        def _warm_runtime_caches() -> None:
            try:
                ...
                # Без get_orders_all: то же делает первый _load_orders главного окна — меньше конкуренции за БД при старте.
                db_models.get_all_clients()
