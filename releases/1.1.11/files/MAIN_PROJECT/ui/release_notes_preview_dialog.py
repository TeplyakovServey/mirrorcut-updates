    ...
    def __init__(
        ...
        *,
        ...
        self._browser.document().setDefaultStyleSheet(
            "body { color: #f0f0f0; font-size: 15px; line-height: 1.45; margin: 0; } "
            "p { margin: 0; padding: 0; line-height: 1.45; } "
            "div.rn-block { margin: 0; padding: 0; } "
            "div.rn-block + div.rn-block { margin-top: 0.12em; } "
