#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Применить 013_delivery_outside_kad_base_2000.sql к PostgreSQL."""
...
def main() -> int:
    path = os.path.join(_HERE, "013_delivery_outside_kad_base_2000.sql")
    ...
    try:
        ...
        for stmt in _sql_statements(text):
            with conn.cursor() as cur:
                cur.execute(stmt)
        conn.commit()
        print("OK: 013_delivery_outside_kad_base_2000")
        return 0
