...
class MainApp(QWidget):
    def __init__(
        ...
        *,
        ...
        self._glass_preview_timer.setInterval(80)
    ...
    def initUI(self):
        ...
        grid.setContentsMargins(TILE_GRID_GAP, TILE_GRID_GAP, 0, TILE_GRID_GAP)
        for r in (1, 2, 3, 4):
            grid.setRowMinimumHeight(r, TILE_SIDE_PX)
        ...
        grid.addWidget(self.polirovka, 1, 2, 1, 1, _at)
        grid.addWidget(self.shlifovka, 1, 3, 1, 1, _at)
        grid.addWidget(self.facet, 1, 4, 1, 1, _at)
        grid.addWidget(self.plenka, 1, 5, 1, 1, _at)

        grid.addWidget(self.otverst, 2, 2, 1, 1, _at)
        grid.addWidget(self.virez, 2, 3, 1, 1, _at)
        grid.addWidget(self.peskostroy, 2, 4, 1, 1, _at)
        grid.addWidget(self.photo, 2, 5, 1, 1, _at)

        grid.addWidget(self.uf, 3, 0, 1, 1, _at)
        grid.addWidget(self.angle, 3, 1, 1, 1, _at)
        grid.addWidget(self.pod, 3, 2, 1, 1, _at)
        grid.addWidget(self.pokraska, 3, 3, 1, 1, _at)
        grid.addWidget(self.furniture, 3, 4, 1, 1, _at)
        grid.addWidget(self.srochno, 3, 5, 1, 1, _at)

        # Нижний ряд: замер|доставка|монтаж (одна широкая плитка), упаковка, доп., кнопки.
        grid.addWidget(self.zamer, 4, 0, 1, 3, _at)
        grid.addWidget(self.packaging, 4, 3, 1, 1, _at)
        grid.addWidget(self.dopi, 4, 4, 1, 1, _at)
        ...
        grid.addWidget(self._actions_bar, 4, 5, 1, 1, Qt.AlignTop | Qt.AlignRight)
